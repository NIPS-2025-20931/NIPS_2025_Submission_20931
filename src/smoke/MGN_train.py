...
def main(args : DictConfig):
    ...
    relative_mesh_pos = pos_t[senders] - pos_t[receivers]
    ...
    ####################################################################################################
    model = MGN_SR(in_features=in_features, hidden_layers=args.hidden_layers, hidden_features=args.hidden_features, out_features=out_features, \
                    node_dim=1, edge_dim=3, g_features=args.g_feats, latent_features=args.latent_feats, enc_layers=args.enc_layers, proc_layers=args.proc_layers, \
                    ...
                    dec_lastact=args.dec_last_act, dec_bias=args.dec_bias, graph_nodes=num_nodes, pooling=args.latent_fuse)
