...
@hydra.main(version_base=None, config_path="conf", config_name="PointGNN_test")
def main(args : DictConfig):
    ...
    ####################################################################################################
    model = PointGNN_SR_3D(in_features=in_features, hidden_layers=args.hidden_layers, hidden_features=args.hidden_features, pc_features=args.latent_feats, \
