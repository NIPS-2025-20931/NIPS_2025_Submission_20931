...
def main(args : DictConfig):
    ...
    model = FLUID_cylinder(input_dim_edge=input_dim_edge, input_dim_node=input_dim_node, num_modes=args.num_modes, hidden_dim=args.latent_feats, output_dim_node=out_features)
