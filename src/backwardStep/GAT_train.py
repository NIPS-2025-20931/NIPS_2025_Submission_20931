...
@hydra.main(version_base=None, config_path="conf", config_name="GAT_train")
def main(args : DictConfig):
    ...
    model = GAT_SR(in_features=in_features, hidden_layers=args.hidden_layers, hidden_features=args.hidden_features, \
                    ...
                    graph_nodes=selected_samples.shape[0], pos_freq_const=10, pos_freq_num=pos_freq_num, pooling=args.latent_fuse)
